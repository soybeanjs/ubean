...
| P6-13 | DevTools Hooks 系统        | ✅   | P1     | `src/core/devtools/server/hooks.ts`                                              | ✅ before/after CRUD hooks系统(createDevToolsHooks)；基于hookable库；registerHook/runHook/removeHook/removeAllHooks API；支持插件扩展；crud:*:before/crud:*:after生命周期                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
