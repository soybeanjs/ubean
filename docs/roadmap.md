...
| P3-13 | Cron 运行时                       | ✅   | P1     | `src/runtime/cron.ts`, `src/core/routing/scan.ts`    | defineScheduled() 定义定时任务、crons/ 目录扫描、getScheduledTasks/runScheduledTask 运行时 API；平台 cron trigger 集成待后续 preset 实现 |
