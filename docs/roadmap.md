...
| P2-12  | defineMeta/defineValidator AST 提取 | 🔄   | P0     | `src/core/routing/define-page.ts`                                | defineMeta/definePage 已用平衡括号+递归解析器重写（支持 <script setup>、嵌套对象）；defineValidator AST 提取待实现 |
