...
| P6-11 | DevTools 内置 Tab          | ✅   | P1     | `src/core/devtools/client/views/`                                                | ✅ Overview/Pages/API Routes/Middlewares/Cron Jobs/Env Vars Tab组件完成；UI使用@soybeanjs/ui组件库(SIcon/SButtonIcon/SConfigProvider)；Vue SFC写法+UnoCSS主题；SConfigProvider包裹提供主题配置；Config/Layouts/Hooks/Virtual Files Tab待后续完善                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| P6-12 | DevTools CRUD              | ✅   | P1     | `src/core/devtools/server/crud.ts`                                               | ✅ CRUD服务器实现：create/read/update/delete/restore操作；支持page/api/layout/middleware/reuse/cron/env/config资源类型；复用CLI Shared Layer(fs-ops/scaffold)；备份机制(.bak文件)；Toast通知反馈；前端CRUD UI使用@soybeanjs/ui组件待完善                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
| P6-14 | DevTools API Playground    | ⬜   | P2     | `src/core/devtools/client/views/ApiRoutes/`                                      | 接口在线测试；集成CodeMirror 6编辑器(P6-25)；UI使用@soybeanjs/ui组件                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| P6-15 | DevTools AI Assistant      | ⬜   | P2     | `src/core/devtools/server/ai.ts`                                                 | LLM function calling 驱动 CRUD；UI使用@soybeanjs/ui的SChat/SDrawer等组件                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| P6-16 | DevTools 自定义 Tab        | ⬜   | P2     | `src/core/devtools/define-tab.ts`                                                | defineDevToolsTab 插件 API；支持用户自定义Tab注册                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
