...
| P6-11 | DevTools 内置 Tab          | ⬜   | P1     | `src/core/devtools/client/views/`                                                | Overview/Pages/API/Config/Env/Layouts/Middlewares/Cron/Hooks/Virtual Files；UI必须使用@soybeanjs/ui组件库(S\*/SConfigProvider)；参考soybean-ui skill；各Tab对应Vue组件开发                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| P6-12 | DevTools CRUD              | ⬜   | P1     | `src/core/devtools/server/{config,env,pages,api,cron}.ts`                        | 复用 CLI Shared Layer；对应前端UI使用@soybeanjs/ui的SModal/SForm/STable等组件                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| P6-13 | DevTools Hooks 系统        | ⬜   | P1     | `src/core/devtools/server/hooks.ts`                                              | before/after CRUD hooks；支持插件扩展                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
