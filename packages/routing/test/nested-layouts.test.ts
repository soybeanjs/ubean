/**
 * P9-17: Nested Layouts (multi-level) — extraction unit tests
 *
...
import { extractDefinePageFromCode } from '../src/define-page';

describe('P9-17: extractDefinePageFromCode — nested layouts', () => {
