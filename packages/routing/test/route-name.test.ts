/**
 * OPT-05 5b — @ubean/routing route-name 纯函数单测
 *
 * 覆盖 generateRouteName / generateLayoutName / generateApiRouteId。
 * 锁定路由名生成规则（pascalCase、动态参数、catch-all、optional、route groups）。
 */
import { describe, it, expect } from 'vitest';
import { generateRouteName, generateLayoutName, generateApiRouteId } from '../src/route-name';
