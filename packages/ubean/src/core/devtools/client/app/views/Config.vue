...
<template>
  <div class="flex flex-col h-full">
    <div class="px-3.5 py-2 border-b border-border bg-card flex-shrink-0">
      <span class="text-xs font-semibold text-foreground">Configuration</span>
    </div>
    <div class="flex-1 overflow-y-auto p-3.5">
      <div class="grid grid-cols-3 gap-2 mb-4">
        <div v-for="stat in stats" :key="stat.label" class="bg-card border border-border rounded-lg p-2.5">
      ...
      <div v-if="configEntries.length > 0" class="bg-card border border-border rounded-lg overflow-hidden">
        ...
        <div class="divide-y divide-border">
          <div
            ...
            :key="key"
            class="flex items-center px-3 py-2 gap-2 hover:bg-secondary/20 transition-colors"
          >
      ...
      <div
        ...
        class="mt-3 bg-card border border-border rounded-lg overflow-hidden"
      >
        <div class="px-3 py-2 border-b border-border bg-muted/30">
