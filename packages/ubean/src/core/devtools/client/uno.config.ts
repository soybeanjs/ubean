  ...
  shortcuts: [
    {
      ...
      'version-badge':
        'inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-semibold bg-primary/10 text-primary',
      'connected-badge':
        'inline-flex items-center pl-3.5 pr-2 py-0.5 rounded-full text-[10px] font-semibold bg-success/12 text-success relative',
      ...
      'create-menu-title':
        'px-3 py-1.5 text-[10px] font-semibold uppercase tracking-wider text-muted-foreground border-b border-border',
      'create-menu-item':
        'w-full flex items-center gap-2.5 px-3 py-2 text-xs hover:bg-secondary/50 cursor-pointer transition-colors text-foreground border-none bg-transparent',
      ...
      'running-badge':
        'inline-flex items-center pl-3.5 pr-2 py-px rounded-full text-[10px] font-semibold bg-success/12 text-success relative',
      ...
      'method-badge':
        'min-w-[46px] px-2 py-0.5 rounded-md text-[10px] font-bold uppercase tracking-wider text-center font-mono',
