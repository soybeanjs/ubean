 ...
 * ## Islands 自动注册
 *
 * 此入口覆盖了 `@ubean/runtime` 的 `hydrateIslands`,在调用前自动从
...
import { hydrateIslands as _hydrateIslands } from '@ubean/runtime';
import type { HydrateIslandsOptions } from '@ubean/runtime';
