...
import { scanPages, extractSlotFromPath } from './scan-pages';
...
export { scanPages, extractSlotFromPath, generatePagesModuleSource, generateTypedRouter, generateVirtualModuleDts };
