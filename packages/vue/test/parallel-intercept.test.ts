/**
 * Parallel Routes / Intercepting Routes — scanning unit tests
 *
...
import { extractSlotAndIntercept } from '../src/scan-pages';

describe('extractSlotAndIntercept — parallel routes', () => {
...
describe('extractSlotAndIntercept — intercepting routes', () => {
...
describe('extractSlotAndIntercept — combinations', () => {
